...
CREATE TABLE IF NOT EXISTS packaging_requests (
    ...
    service_type ENUM('standard_order','team_consultation') NOT NULL DEFAULT 'standard_order',
...
CREATE TABLE IF NOT EXISTS request_message_reads (
    ...
    CONSTRAINT fk_reads_request FOREIGN KEY (request_id) REFERENCES packaging_requests(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
